...
const Slider = () => {
	...
	return (
		<section className='flex items-center relative lg:h-[500px] md:h-[400px] sm:h-[300px] mt-5 mb-2 rounded-md overflow-hidden'>
			<img
			...
			<div className='absolute top-4 sm:h-1/6 xs:min-h-[48px] xs:2/6 w-5/12 bg-red/40 rounded-r-md z-30 overflow-hidden '>
				<h1 className='pr-5 lg:text-3xl md:text-2xl sm:text-xl xs:leading-5 sm:leading-6 xs:text-md text-white font-bold text-right'>
					{sliderTitle}
				</h1>
			</div>
		</section>
